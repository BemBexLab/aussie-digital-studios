...
function normalizeTitle(project: RawPortfolioProject, fallbackId: string): string {
...
function normalizePortfolioProject(
  ...
  const isWebsiteProject = cleanString(project.category) === "Website Development & Design";
